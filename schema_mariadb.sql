CREATE TABLE `board` (
	...
	`USERID` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8_bin',
	PRIMARY KEY (`NO`),
	INDEX `board_idx1` (`REGDATE`),
	INDEX `board_fk1` (`USERID`),
	CONSTRAINT `board_fk1` FOREIGN KEY (`USERID`) REFERENCES `tbl_member` (`userid`) ON UPDATE CASCADE ON DELETE NO ACTION
)
COLLATE='utf8_bin'
ENGINE=InnoDB
;
